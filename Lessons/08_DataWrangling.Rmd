...
## why is this not making the date in the right format???????
...
#seperate will seperate the column and remove the original, if you want to retain the original use mutate
