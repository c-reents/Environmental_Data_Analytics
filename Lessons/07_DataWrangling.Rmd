...
>data wrangling is manipulating data sets into the format needed for analysis, you may want to visualize the data prior to wrangling 
...
# matrix filtering, need to provide rows and columns which is why there is a comma at the end
...
# Choose multiple conditions to filter: filtering selects spcific rows
...
NTL.phys.data.Tues.9099<- filter(NTL.phys.data, lakename=="Tuesday Lake" & year4<2000 & year4>1989)
...
#Hummingbird, East Long, low depth (0.0-0.5), summer months
...
#new data set has same name as old data set
