...
<Fill in our discussion below with bullet points. Use italics and bold for emphasis> the carrots make the words not show up in the pdf 

adding bullets: 

- code output and text/notes all together in one doc
- can knit to useful formats (html, pdf, docx)
