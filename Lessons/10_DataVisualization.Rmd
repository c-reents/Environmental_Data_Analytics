...
#theme classic: Kateri's favorite
```
...
theme_set(mytheme)
#will use this theme throughout the remainder of the session
...
#getting hex codes for colors and visualizing the colors
...
NvsP2 <-
  ...
  theme(legend.position = "right", 
        legend.text = element_text(size = 12), legend.title ="Depth", element_text(size = 12) )
#labs() helps you relabel anything in your aes()
#paste function can get greek letters
print(NvsP2)
...
Nutrientplot <-
  ...
  geom_boxplot() +
  labs(x="", y= "Concentration", color= "Nutrient")+
