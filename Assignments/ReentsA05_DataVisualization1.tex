...
\includegraphics{ReentsA05_DataVisualization1_files/figure-latex/unnamed-chunk-3-1.pdf}
...
\includegraphics{ReentsA05_DataVisualization1_files/figure-latex/unnamed-chunk-4-1.pdf}
...
\includegraphics{ReentsA05_DataVisualization1_files/figure-latex/unnamed-chunk-5-1.pdf}
...
\begin{Highlighting}[]
\CommentTok{#7 }
\KeywordTok{class}\NormalTok{(ECOTOX_Neonicotinoids_Mortality_raw}\OperatorTok{$}\NormalTok{Conc..Mean..Std.)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ECOTOX_Neonicotinoids_Mortality_raw}\OperatorTok{$}\NormalTok{Conc..Mean..Std.<-}\StringTok{ }\KeywordTok{as.integer}\NormalTok{(ECOTOX_Neonicotinoids_Mortality_raw}\OperatorTok{$}\NormalTok{Conc..Mean..Std.)}


\NormalTok{graph.num.}\DecValTok{7}\NormalTok{ <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(ECOTOX_Neonicotinoids_Mortality_raw, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Pub..Year , }\DataTypeTok{y=}\NormalTok{ Conc..Mean..Std., }\DataTypeTok{color=}\NormalTok{Chemical.Name))}\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x=}\StringTok{"Publication Year"}\NormalTok{, }\DataTypeTok{y=}\StringTok{"Mean Concentration"}\NormalTok{, }\DataTypeTok{color=}\StringTok{"Chemical Name"}\NormalTok{)}\OperatorTok{+}
...
\includegraphics{ReentsA05_DataVisualization1_files/figure-latex/unnamed-chunk-6-1.pdf}
